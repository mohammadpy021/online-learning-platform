...
# CORS_ORIGIN_WHITELIST = ['http://127.0.0.1:1337']
...
STATIC_URL = "static/"
STATICFILES_DIRS = [BASE_DIR / "static"]  #for finding like {load static} #developement
STATIC_ROOT = BASE_DIR / "staticfiles/"  # new #deplyment
MEDIA_URL = 'media/'
